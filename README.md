...
## Step 5
- [ ] 기물의 색, 종류를 나타내는 enum 구현한다.
  - [ ] 검정색, 흰색, 빈 공간을 나타내는 색 총 3가지가 존재한다.
  - [ ] Piece 클래스에서만 알 수 있도록 구현한다.
  - [ ] enum을 적용하며 수정이 필요한 부분을 수정한다.
- [ ] 기물 생성 팩토리 메소드에서 enum을 사용하도록 변경한다.
  - [ ] 팩토리 메소드에서 중복된 코드를 리팩토링한다.
